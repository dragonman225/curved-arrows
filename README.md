...
| `allowedStartSides`   | [`RectSide[]`](https://github.com/dragonman225/curved-arrows/blob/8bf973011dabe7c9d713ef616c3e6ed9fa6e6cdb/src/utils.ts#L1) | `['top', 'right', 'bottom', 'left']` | Constrain which sides of the start box allow the arrow to start. |
| `allowedEndSides`     | [`RectSide[]`](https://github.com/dragonman225/curved-arrows/blob/8bf973011dabe7c9d713ef616c3e6ed9fa6e6cdb/src/utils.ts#L1) | `['top', 'right', 'bottom', 'left']` | Constrain which sides of the end box allow the arrow to end. |
